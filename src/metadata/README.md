 ...
 * [vccf.yml](vccf.yml)
     * Determines how your purl.obolibrary.org/obo/vccf/ redirects will be handled
     ...
     * Paste in the contents of [vccf.yml](vccf.yml)
 ...
 * [vccf.md](vccf.md)
     ...
     * Paste in the contents of [vccf.md](vccf.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
